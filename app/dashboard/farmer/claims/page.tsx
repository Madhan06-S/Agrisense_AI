...
import { ArrowLeft, FileText, Loader2, Plus, Shield } from "lucide-react";
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50">
                    <th className="text-left font-medium text-slate-700 px-5 py-3">Claim ID</th>
                    <th className="text-left font-medium text-slate-700 px-5 py-3">Damage Type</th>
                    <th className="text-left font-medium text-slate-700 px-5 py-3">Date</th>
                    <th className="text-left font-medium text-slate-700 px-5 py-3">AI Score</th>
                    <th className="text-left font-medium text-slate-700 px-5 py-3">Status</th>
                  </tr>
                </thead>
